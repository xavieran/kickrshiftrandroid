...
import com.xavieran.kickrshiftrandroid.databinding.ActivityMainBinding
    ...
    private val scanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            ...
            if (name == null || !name.contains("Wahoo")) {
                Timber.w("${result.device.name} not a wahoo device")
                return;
            }
    ...
    private val connectionEventListener by lazy {
        ConnectionEventListener().apply {
            onConnectionSetupComplete = { gatt ->
                Intent(this@MainActivity, ShifterActivity::class.java).also {
